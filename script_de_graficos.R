...
plot(nodes, cube_cp_cbr[,3,1], xlab='Número de nós', ylim=c(min, max), ylab='Perda média de pacotes por segundo', xaxp=c(5,40,7), type="b", col="blue", lwd=2, pch=19, main='Perda Média de Pacotes por segundo')
print_error(calc_error(cube_cp_cbr[,3,]), cube_cp_cbr[,3,1], 'blue')
...
plot(nodes, cube_cp_cbr[,3,1], xlab='Número de nós', ylim=c(min, max), ylab='Pacotes perdidos por segundo', xaxp=c(5,40,7), type="b", col="blue", lwd=2, pch=19, main='CBR - Perda de Pacotes em Nós Estáticos')
print_error(calc_error(cube_cp_cbr[,3,]), cube_cp_cbr[,3,1], 'blue')
