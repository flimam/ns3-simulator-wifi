...
points(cp_cbr[,1], cp_pulse[,2], type='b', col='orange', lwd=2, pch=16)
...
points(cp_cbr[,1], cp_pulse[,3], type='b', col='orange', lwd=2, pch=16)
...
points(cp_cbr[,1], cp_pulse[,4], type='b', col='orange', lwd=2, pch=16)
