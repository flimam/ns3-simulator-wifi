...
rw_cbr <- read.csv(paste(args[1],"RandomWalk_cbr.csv",sep="_"), header=F, sep=";")
cp_cbr <- read.csv(paste(args[1],"ConstantPosition_cbr.csv",sep="_"), header=F, sep=";")
rw_pulse <- read.csv(paste(args[1],"RandomWalk_pulse.csv",sep="_"), header=F, sep=";")
cp_pulse <- read.csv(paste(args[1],"ConstantPosition_pulse_cbr.csv",sep="_"), header=F, sep=";")
n_cbr <- read.csv(paste(args[1],"Nearest_node_cbr.csv",sep="_"), header=F, sep=";")
n_pulse <- read.csv(paste(args[1],"Nearest_node_pulse.csv",sep="_"), header=F, sep=";")
f_cbr <- read.csv(paste(args[1],"Farthest_node_cbr.csv",sep="_"), header=F, sep=";")
f_pulse <- read.csv(paste(args[1],"Farthest_node_pulse.csv",sep="_"), header=F, sep=";")
...
points(cp_pulse[,1], cp_pulse[,2], type='b', col='orange', lwd=2, pch=16)
points(n_pulse[,1], n_pulse[,3], type='b', col='purple', lwd=2, pch=15)
points(f_pulse[,1], f_pulse[,3], type='b', col='yellow', lwd=2, pch=14)
grid(col='black')
