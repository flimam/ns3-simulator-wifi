...
for (i in seq(from=5, to=40, by=5)){
  ...
  system(paste("NS_GLOBAL_VALUE=\"RngRun=3\" ./waf --run \"scratch/wifiinfra --nodes=",i," --runningTime=20 --traffic=true --mobility=false --printLog=false --prefix=\\\"",args[1],"\\\"   \"", collapse=", ", sep=""))
  print("CBR e nos moveis")
  system(paste("NS_GLOBAL_VALUE=\"RngRun=3\" ./waf --run \"scratch/wifiinfra --nodes=",i," --runningTime=20 --traffic=true --mobility=true --printLog=false --prefix=\\\"",args[1],"\\\"    \"", collapse=", ", sep=""))
  print("Rajada e nos fixos")
  system(paste("NS_GLOBAL_VALUE=\"RngRun=3\" ./waf --run \"scratch/wifiinfra --nodes=",i," --runningTime=20 --traffic=false --mobility=false --printLog=false --prefix=\\\"",args[1],"\\\"   \"", collapse=", ", sep=""))
  print("Rajada e nos moveis")
  system(paste("NS_GLOBAL_VALUE=\"RngRun=3\" ./waf --run \"scratch/wifiinfra --nodes=",i," --runningTime=20 --traffic=false --mobility=true --printLog=false --prefix=\\\"",args[1],"\\\"   \"", collapse=", ", sep=""))
}
